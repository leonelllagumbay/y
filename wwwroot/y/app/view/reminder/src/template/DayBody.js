 ...
 */
Ext.define('iBOSe.view.reminder.src.template.DayBody', {
    ...
    applyTemplate : function(o){
        this.today = iBOSe.view.reminder.src.util.Date.today();
        ...
        for(; i<this.dayCount; i++){
            days[i] = iBOSe.view.reminder.src.util.Date.add(dt, {days: i});
        }
        ...
        for(i=0; i<24; i++){
            ...
            dt = iBOSe.view.reminder.src.util.Date.add(dt, {hours: 1});
        }
