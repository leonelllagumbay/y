 ...
 */
Ext.define('iBOSe.view.reminder.src.template.DayHeader', {
    extend: 'Ext.XTemplate',
    
    //requires: ['iBOSe.view.reminder.src.template.BoxLayout'],
    
    constructor: function(config){
        
        Ext.apply(this, config);
        
        this.allDayTpl = new iBOSe.view.reminder.src.template.BoxLayout(config);
