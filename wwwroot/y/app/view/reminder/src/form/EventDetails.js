...
Ext.define('iBOSe.view.reminder.src.form.EventDetails', {
    ...
    initComponent: function() {
        this.titleField = new Ext.form.Text({
            fieldLabel: 'Title',
            name: iBOSe.view.reminder.src.data.EventMappings.getFields()[0].Title.name,
        ...
        this.notesField = new Ext.form.TextArea({
            fieldLabel: 'Notes',
            name: iBOSe.view.reminder.src.data.EventMappings.getFields()[0].Notes.name,
            grow: true,
            growMax: 150,
            anchor: '100%'
        });
        this.locationField = new Ext.form.Text({
            fieldLabel: 'Location',
            name: iBOSe.view.reminder.src.data.EventMappings.getFields()[0].Location.name,
            anchor: '100%'
        });
        this.urlField = new Ext.form.Text({
            fieldLabel: 'Web Link',
            name: iBOSe.view.reminder.src.data.EventMappings.getFields()[0].Url.name,
            anchor: '100%'
        });
        ...
        if (this.calendarStore) {
            this.calendarField = new iBOSe.view.reminder.src.form.field.CalendarCombo({
                ...
                anchor: '70%',
                name: iBOSe.view.reminder.src.data.EventMappings.getFields()[0].CalendarId.name
            });
    ...
    loadRecord: function(rec){
        ...
        if(this.calendarStore){
            this.form.setValues({
                'calendar': rec.data[iBOSe.view.reminder.src.data.EventMappings.getFields()[0].CalendarId.name]
            });
        }
