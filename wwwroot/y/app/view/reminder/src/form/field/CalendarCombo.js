 ...
 */
Ext.define('iBOSe.view.reminder.src.form.field.CalendarCombo', {
    ...
    initComponent: function(){
        this.valueField = iBOSe.view.reminder.src.data.CalendarMappings.CalendarId.name;
        this.displayField = iBOSe.view.reminder.src.data.CalendarMappings.Title.name;
    ...
    getListItemTpl: function(displayField) {
        return '<div class="x-combo-list-item ext-color-{' + iBOSe.view.reminder.src.data.CalendarMappings.CalendarId.name +
    ...
    getStyleClass: function(value){
        ...
        if (!Ext.isEmpty(val)) {
            ...
            return 'ext-color-' + (val.data ? val.data[iBOSe.view.reminder.src.data.CalendarMappings.CalendarId.name] : val); 
        }
        return '';
    },
    ...
    setValue: function(value) {
        if (!value && this.store.getCount() > 0) {
            ...
            value = this.store.getAt(0).data[iBOSe.view.reminder.src.data.CalendarMappings.CalendarId.name];
        }
