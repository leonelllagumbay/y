...
Ext.define('iBOSe.view.reminder.src.form.field.DateRange', {
    ...
    setValue: function(v){
        ...
        else if(v[iBOSe.view.reminder.src.data.EventMappings.getFields()[0].StartDate.name]){ //object
            this.setDT(v[iBOSe.view.reminder.src.data.EventMappings.getFields()[0].StartDate.name], 'start');
            if(!this.setDT(v[iBOSe.view.reminder.src.data.EventMappings.getFields()[0].EndDate.name], 'end')){
                this.setDT(v[iBOSe.view.reminder.src.data.EventMappings.getFields()[0].StartDate.name], 'end');
            }
            this.allDay.setValue(!!v[iBOSe.view.reminder.src.data.EventMappings.getFields()[0].IsAllDay.name]);
        }
    },
