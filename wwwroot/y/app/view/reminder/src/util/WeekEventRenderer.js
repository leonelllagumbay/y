                        ...
                        if (wk[d]) {
                            ...
                            for (; ev < ct; ev++) {
                                ...
                                if (!evt.isSpan || evt.isSpanStart) {
                                    ...
                                    item._weekIndex = w;
                                    item._renderAsAllDay = item[iBOSe.view.reminder.src.data.EventMappings.getFields()[0].IsAllDay.name] || evt.isSpanStart;
                                    
                                    var stm = new Date(item[iBOSe.view.reminder.src.data.EventMappings.getFields()[0].StartDate.name]);
                                    var etm = new Date(item[iBOSe.view.reminder.src.data.EventMappings.getFields()[0].EndDate.name]);
                                    ...
                                    var diff = iBOSe.view.reminder.src.util.Date.diffDays(dt, new Date(item[iBOSe.view.reminder.src.data.EventMappings.getFields()[0].EndDate.name])) + 1,
