...
Ext.define('iBOSe.view.reminder.src.view.DayBody', {
    ...
    onEventResize: function(rec, data) {
        ...
        start = new Date(iBOSe.view.reminder.src.data.EventMappings.getFields()[0].StartDate.name),
        end = new Date(iBOSe.view.reminder.src.data.EventMappings.getFields()[0].EndDate.name);
    ...
    getTemplateEventData: function(evt) {
        var selector = this.getEventSelectorCls(evt[iBOSe.view.reminder.src.data.EventMappings.getFields()[0].EventId.name]),
            data = {},
    ...
    getTemplateEventBox: function(evt) {
        var heightFactor = 0.7,
            start = new Date(evt[iBOSe.view.reminder.src.data.EventMappings.getFields()[0].StartDate.name]),
            end = new Date(evt[iBOSe.view.reminder.src.data.EventMappings.getFields()[0].EndDate.name]),
