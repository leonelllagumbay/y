    ...
    getDragData: function(e) {
        ...
        if (t) {
            ...
            return {
                type: 'eventdrag',
                ddel: t,
                eventStart: rec.data[iBOSe.view.reminder.src.data.EventMappings.getFields()[0].StartDate.name],
                eventEnd: rec.data[iBOSe.view.reminder.src.data.EventMappings.getFields()[0].EndDate.name],
                proxy: this.proxy
            };
        }
