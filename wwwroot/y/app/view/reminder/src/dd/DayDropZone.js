 ...
 */
Ext.define('iBOSe.view.reminder.src.dd.DayDropZone', {
    extend: 'iBOSe.view.reminder.src.dd.DropZone',
    requires: [
    ...
    onNodeOver: function(n, dd, e, data) {
        ...
        if (data.type == 'caldrag') {
            ...
            curr = iBOSe.view.reminder.src.util.Date.copyTime(n.date, this.dragCreateDt);
            this.dragStartDate = iBOSe.view.reminder.src.util.Date.min(this.dragCreateDt, curr);
            this.dragEndDate = endDt || iBOSe.view.reminder.src.util.Date.max(this.dragCreateDt, curr);
            ...
            if (data.type == 'eventresize') {
                ...
                curr = iBOSe.view.reminder.src.util.Date.copyTime(n.date, this.resizeDt);
                start = iBOSe.view.reminder.src.util.Date.min(data.eventStart, curr);
                end = iBOSe.view.reminder.src.util.Date.max(data.eventStart, curr);
