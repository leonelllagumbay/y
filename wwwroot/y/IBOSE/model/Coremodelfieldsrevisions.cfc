<!---
  --- Coremodelfieldsrevisions
  --- ----------
  ---
  --- author: Leonell
  --- date:   29/02/16
  --->
<cfcomponent output="false" persistent="true" name="Coremodelfieldsrevisions" table="coremodelfieldsrevisions">

	<cfproperty name="MREVISIONID" fieldtype="id" generator="native" column="MREVISIONID" />
	<cfproperty name="MMODELFIELDS" column="MMODELFIELDS" ormType="int" />
